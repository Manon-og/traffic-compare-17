export default {
  ...
  description:
    "Hybrid dataset: Defense training performance + Thesis LSTM data + Enhanced logging",
  config: {
    episode: 1,
  ...
  training_results: [
    {
      ...
      steps: 300,
      time_minutes: 1.1973313570022583,
      avg_loss: 0.12233736459165812,
      epsilon: 0.8886698277259029,
      vehicles: 355,
      completed_trips: 507,
      passenger_throughput: 8296.363636363638,
      memory_size: 300,
      avg_waiting_time: 6.1,
      avg_queue_length: 110,
      avg_speed: 15.5,
      jeepneys_processed: 119,
      buses_processed: 44,
      trucks_processed: 5,
      motorcycles_processed: 11,
      cars_processed: 300,
      pt_passenger_throughput: 3206.0,
    ...
    },
    {
      ...
      avg_loss: 0.07287731798986594,
      epsilon: 0.764856516910148,
      vehicles: 365,
      completed_trips: 494,
      passenger_throughput: 8083.636363636364,
      memory_size: 600,
      avg_waiting_time: 5.9,
      avg_queue_length: 109,
      avg_speed: 15.8,
      jeepneys_processed: 120,
      buses_processed: 45,
      trucks_processed: 5,
      motorcycles_processed: 5,
      cars_processed: 300,
      pt_passenger_throughput: 3255.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 58,
          total_queue: 21,
    ...
    },
    {
      ...
      avg_loss: 0.05948415689791242,
      epsilon: 0.658293410227447,
      vehicles: 372,
      completed_trips: 526,
      passenger_throughput: 8607.272727272728,
      memory_size: 900,
      avg_waiting_time: 6.0,
      avg_queue_length: 110,
      avg_speed: 15.7,
      jeepneys_processed: 122,
      buses_processed: 45,
      trucks_processed: 7,
      motorcycles_processed: 24,
      cars_processed: 300,
      pt_passenger_throughput: 3283.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 59,
          total_queue: 22,
    ...
    },
    {
      ...
      avg_loss: 0.04912886410951614,
      epsilon: 0.5665771348847519,
      vehicles: 348,
      completed_trips: 518,
      passenger_throughput: 8476.363636363638,
      memory_size: 1200,
      avg_waiting_time: 4.9,
      avg_queue_length: 119,
      avg_speed: 17.7,
      jeepneys_processed: 121,
      buses_processed: 45,
      trucks_processed: 8,
      motorcycles_processed: 24,
      cars_processed: 300,
      pt_passenger_throughput: 3269.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 58,
          total_queue: 23,
    ...
    },
    {
      ...
      memory_size: 1500,
      avg_waiting_time: 4.9,
      avg_queue_length: 105,
      avg_speed: 17.4,
      jeepneys_processed: 117,
      buses_processed: 44,
      trucks_processed: 8,
      motorcycles_processed: 25,
      cars_processed: 300,
      pt_passenger_throughput: 3178.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 50,
          total_queue: 21,
    ...
    },
    {
      ...
      avg_loss: 0.041631448927025,
      epsilon: 0.4196991758284578,
      vehicles: 343,
      completed_trips: 477,
      passenger_throughput: 7805.454545454546,
      memory_size: 1800,
      avg_waiting_time: 5.7,
      avg_queue_length: 105,
      avg_speed: 16.1,
      jeepneys_processed: 120,
      buses_processed: 45,
      trucks_processed: 7,
      motorcycles_processed: 20,
      cars_processed: 300,
      pt_passenger_throughput: 3255.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      avg_loss: 0.03705205333729585,
      epsilon: 0.3612248776305073,
      vehicles: 362,
      completed_trips: 474,
      passenger_throughput: 7756.363636363637,
      memory_size: 2100,
      avg_waiting_time: 5.5,
      avg_queue_length: 111,
      avg_speed: 16.6,
      jeepneys_processed: 118,
      buses_processed: 44,
      trucks_processed: 0,
      motorcycles_processed: 7,
      cars_processed: 300,
      pt_passenger_throughput: 3192.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 56,
          total_queue: 22,
    ...
    },
    {
      ...
      avg_loss: 0.03312052066748341,
      epsilon: 0.31089747069817225,
      vehicles: 347,
      completed_trips: 487,
      passenger_throughput: 7969.09090909091,
      memory_size: 2400,
      avg_waiting_time: 6.2,
      avg_queue_length: 106,
      avg_speed: 15.2,
      jeepneys_processed: 119,
      buses_processed: 44,
      trucks_processed: 5,
      motorcycles_processed: 21,
      cars_processed: 300,
      pt_passenger_throughput: 3206.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      memory_size: 2700,
      avg_waiting_time: 6.0,
      avg_queue_length: 102,
      avg_speed: 15.4,
      jeepneys_processed: 120,
      buses_processed: 45,
      trucks_processed: 0,
      motorcycles_processed: 9,
      cars_processed: 300,
      pt_passenger_throughput: 3255.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      avg_queue_length: 112,
      avg_speed: 17.4,
      jeepneys_processed: 120,
      buses_processed: 45,
      trucks_processed: 7,
      motorcycles_processed: 15,
      cars_processed: 300,
      pt_passenger_throughput: 3255.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      avg_loss: 0.0630051873313884,
      epsilon: 0.14683002409689105,
      vehicles: 316,
      completed_trips: 448,
      passenger_throughput: 7330.909090909091,
      memory_size: 3900,
      avg_waiting_time: 4.8,
      avg_queue_length: 103,
      avg_speed: 17.4,
      jeepneys_processed: 117,
      buses_processed: 44,
      trucks_processed: 7,
      motorcycles_processed: 19,
      cars_processed: 300,
      pt_passenger_throughput: 3178.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      avg_loss: 0.05485026737675071,
      epsilon: 0.1087661967030719,
      vehicles: 328,
      completed_trips: 472,
      passenger_throughput: 7723.636363636364,
      memory_size: 4500,
      avg_waiting_time: 5.3,
      avg_queue_length: 102,
      avg_speed: 16.5,
      jeepneys_processed: 117,
      buses_processed: 44,
      trucks_processed: 4,
      motorcycles_processed: 22,
      cars_processed: 300,
      pt_passenger_throughput: 3178.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      avg_queue_length: 99,
      avg_speed: 16.2,
      jeepneys_processed: 115,
      buses_processed: 43,
      trucks_processed: 1,
      motorcycles_processed: 18,
      cars_processed: 300,
      pt_passenger_throughput: 3115.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 50,
          total_queue: 19,
    ...
    },
    {
      ...
      avg_loss: 0.054019305389374495,
      epsilon: 0.059683198227410465,
      vehicles: 356,
      completed_trips: 505,
      passenger_throughput: 8263.636363636364,
      memory_size: 5700,
      avg_waiting_time: 5.4,
      avg_queue_length: 115,
      avg_speed: 16.9,
      jeepneys_processed: 120,
      buses_processed: 45,
      trucks_processed: 0,
    ...
    },
    {
      ...
      memory_size: 8700,
      avg_waiting_time: 4.8,
      avg_queue_length: 122,
      avg_speed: 18.0,
      jeepneys_processed: 122,
      buses_processed: 45,
      trucks_processed: 7,
      motorcycles_processed: 23,
      cars_processed: 300,
      pt_passenger_throughput: 3283.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      avg_queue_length: 96,
      avg_speed: 16.1,
      jeepneys_processed: 116,
      buses_processed: 43,
      trucks_processed: 1,
      motorcycles_processed: 6,
      cars_processed: 300,
      pt_passenger_throughput: 3129.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 48,
          total_queue: 19,
    ...
    },
    {
      ...
      avg_loss: 0.09099100561191638,
      epsilon: 0.009995187929535779,
      vehicles: 335,
      completed_trips: 495,
      passenger_throughput: 8100.000000000001,
      memory_size: 10500,
      avg_waiting_time: 5.8,
      avg_queue_length: 103,
      avg_speed: 15.8,
      jeepneys_processed: 121,
      buses_processed: 45,
    ...
    },
    {
      ...
      avg_loss: 0.0865798071026802,
      epsilon: 0.009995187929535779,
      vehicles: 364,
      completed_trips: 533,
      passenger_throughput: 8721.818181818182,
      memory_size: 10800,
      avg_waiting_time: 6.4,
      avg_queue_length: 111,
      avg_speed: 15.1,
      jeepneys_processed: 120,
      buses_processed: 45,
      trucks_processed: 4,
      motorcycles_processed: 16,
      cars_processed: 300,
      pt_passenger_throughput: 3255.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
    ...
    },
    {
      ...
      motorcycles_processed: 25,
      cars_processed: 300,
      pt_passenger_throughput: 3143.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 52,
          total_queue: 20,
    ...
    },
    {
      ...
      avg_queue_length: 115,
      avg_speed: 18.0,
      jeepneys_processed: 123,
      buses_processed: 46,
      trucks_processed: 8,
      motorcycles_processed: 16,
      cars_processed: 300,
      pt_passenger_throughput: 3332.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 54,
          total_queue: 23,
    ...
    },
    {
      ...
      avg_queue_length: 115,
      avg_speed: 16.6,
      jeepneys_processed: 124,
      buses_processed: 46,
      trucks_processed: 5,
      motorcycles_processed: 10,
      cars_processed: 300,
      pt_passenger_throughput: 3346.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 59,
          total_queue: 23,
    ...
    },
    {
      ...
      avg_loss: 0.2335866572211186,
      epsilon: 0.009995187929535779,
      vehicles: 332,
      completed_trips: 470,
      passenger_throughput: 7690.909090909092,
      memory_size: 50000,
      avg_waiting_time: 4.4,
      avg_queue_length: 114,
      avg_speed: 18.0,
      jeepneys_processed: 118,
      buses_processed: 44,
    ...
    },
    {
      ...
      avg_loss: 0.23572950735688208,
      epsilon: 0.009995187929535779,
      vehicles: 340,
      completed_trips: 503,
      passenger_throughput: 8230.909090909092,
      memory_size: 50000,
      avg_waiting_time: 4.1,
      avg_queue_length: 115,
      avg_speed: 18.0,
      jeepneys_processed: 121,
      buses_processed: 45,
    ...
    },
    {
      ...
      motorcycles_processed: 5,
      cars_processed: 300,
      pt_passenger_throughput: 3318.0,
      intersection_metrics: {
        Ecoland_TrafficSignal: {
          total_vehicles: 61,
          total_queue: 22,
    ...
    },
    {
      ...
      avg_loss: 0.21858838640153408,
      epsilon: 0.009995187929535779,
      vehicles: 384,
      completed_trips: 516,
      passenger_throughput: 8443.636363636364,
      memory_size: 50000,
      avg_waiting_time: 4.6,
      avg_queue_length: 119,
      avg_speed: 18.0,
      jeepneys_processed: 119,
      buses_processed: 44,
  ...
  episode_count: 300,
  compilation_timestamp: "2025-10-23T10:08:27.959713",
} as const;
